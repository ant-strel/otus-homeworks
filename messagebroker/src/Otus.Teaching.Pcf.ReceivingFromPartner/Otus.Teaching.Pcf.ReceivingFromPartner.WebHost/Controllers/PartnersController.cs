...
namespace Otus.Teaching.Pcf.ReceivingFromPartner.WebHost.Controllers
{
        ...
        : ControllerBase
    {
        ...
        public PartnersController(IRepository<Partner> partnersRepository,
            ...
            IBusControl busContsol            )
        {
            _partnersRepository = partnersRepository;
            _preferencesRepository = preferencesRepository;
            _notificationGateway = notificationGateway;
            _busControl = busContsol;
        }
            ...
            ReceivingPromoCodeRequest request)
        {
            ...
            GivePromoCodeToCustomerDto rmqDto = PromoCodeMapper.MapGivePromocodeToCustomerFromModel(request,preference, partner);
            ...
            await _busControl.Publish(rmqDto);
            ...
            {
                await _busControl.Publish(new PartnerManagerGivedPromocodeDTO { PartnerManagerId = request.PartnerManagerId.Value });
            }
